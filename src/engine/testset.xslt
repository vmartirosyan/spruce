...
{
	string _DirPrefix("<xsl:value-of select="$TestClassName" />_<xsl:value-of select="@Name"/>_dir_");
	string _FilePrefix("<xsl:value-of select="$TestClassName" />_<xsl:value-of select="@Name"/>_file_");
...
Test <xsl:value-of select="/TestSet/@Name" />Test_<xsl:value-of select="position()" />(
		"<xsl:value-of select="@Name" />",
		"<xsl:value-of select="Description" />",
		<xsl:value-of select="@Name" />Func);

	
</xsl:for-each>

Test <xsl:value-of select="/TestSet/@Name" />tests[] = {
<xsl:for-each select="Test">
	<xsl:value-of select="/TestSet/@Name" />Test_<xsl:value-of select="position()" />
	<xsl:if test="position()!=count(//Test)">,</xsl:if>
</xsl:for-each>
};

TestSet <xsl:value-of select="$TestSetName" />Tests("<xsl:value-of select="/TestSet/@Name" />", <xsl:value-of select="/TestSet/@Name" />tests, <xsl:value-of select="count(//Test)" /> );
