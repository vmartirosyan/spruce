...
int LseekTest::Main(vector<string>)
{
	...
	{	
         switch (_operation)
		{
			...
			case Lseek64NormalCase1:		   
				return Lseek64TestNormalCase1Func();			    
			case Lseek64NormalCase2:
				return Lseek64TestNormalCase2Func();
...
Status LseekTest :: Lseek64TestNormalCase1Func()
{
	int whence = 1;
	int fd, ret_lseek64;
